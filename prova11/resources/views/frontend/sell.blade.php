...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- Aggiungi i collegamenti ai file CSS e JS (verranno creati successivamente) -->
</head>
<body>
...
<div class="sell-container">
    ...
    <!-- Aggiungi questo div per l'overlay -->
<form action="{{url('/sell')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="overlay">
    <div class="sell-form">
    <div class="sell-form-container">
    <h4>Inserisci i dettagli del tuo annuncio</h4>
    ...
    <div id="erroreNumeri" class="errore"></div> <!-- Aggiunto div per il messaggio di errore -->
